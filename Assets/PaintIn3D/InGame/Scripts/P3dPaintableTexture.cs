...
namespace PaintIn3D
{
	...
	public class P3dPaintableTexture_Editor : P3dEditor
	{
		...
		protected override void OnInspector()
		{
			...
			var showTexture = DrawExpand("slot", "The material index and shader texture slot name that this component will paint.");
			...
			if (showTexture == true)
			{
				BeginIndent();
					BeginDisabled();
						EditorGUI.ObjectField(Reserve(), new GUIContent("Texture", "This is the current texture in the specified texture slot."), tgt.Slot.FindTexture(tgt.gameObject), typeof(Texture), false);
					EndDisabled();
				EndIndent();
			}
